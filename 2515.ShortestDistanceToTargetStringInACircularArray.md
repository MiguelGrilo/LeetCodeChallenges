# 2515. Shortest Distance to Target String in a Circular Array [Challenge](https://leetcode.com/problems/shortest-distance-to-target-string-in-a-circular-array/)

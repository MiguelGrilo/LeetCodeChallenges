# 66. Plus One [Challenge](https://leetcode.com/problems/plus-one/description/)
...
public class Solution {
    public int[] PlusOne(int[] digits) {
        ...
        for (int i = digits.Length - 1; i >= 0; i--) 
        {
            ...
            // In case the last number is 9
            digits[i] = 0;
        }
        // If the cycle finishes it means all digits were 9 and we need a bigger array for the solution
